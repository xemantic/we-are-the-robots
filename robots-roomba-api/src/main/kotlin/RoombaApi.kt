...
open class RoombaState(s: State<RoombaState>) {
  ...
  val wheelDropLeft               by s.property(false)
  val wheelDropRight              by s.property(false)
  val bumpLeft                    by s.property(false)
  val bumpRight                   by s.property(false)
  val wall                        by s.property(false)
  val cliffLeft                   by s.property(false)
  val cliffFrontLeft              by s.property(false)
  val cliffFrontRight             by s.property(false)
  val cliffRight                  by s.property(false)
  val leftWheelOvercurrent        by s.property(false)
  val rightWheelOvercurrent       by s.property(false)
  val mainBrushOvercurrent        by s.property(false)
  val sideBrushOvercurrent        by s.property(false)
  val dirtDetect                  by s.property(0)
  val infraredCharacterOmni       by s.property(0)
  val infraredCharacterLeft       by s.property(0)
  val infraredCharacterRight      by s.property(0)
  val distance                    by s.property(0)
  val angle                       by s.property(0)
  val chargingState               by s.property(ChargingState.NOT_CHARGING)
  val current                     by s.property(0)
  val batteryCharge               by s.property(0)
  val batteryCapacity             by s.property(10)
  val wallSignal                  by s.property(0)
  val cliffLeftSignal             by s.property(0)
  val cliffFrontLeftSignal        by s.property(0)
  val cliffFrontRightSignal       by s.property(0)
  val cliffRightSignal            by s.property(0)
  val oiMode                      by s.property(OiMode.OFF)

  val lightBumpLeft               by s.property(false)
  val lightBumpFrontLeft          by s.property(false)
  val lightBumpCenterLeft         by s.property(false)
  val lightBumpCenterRight        by s.property(false)
  val lightBumpFrontRight         by s.property(false)
  val lightBumpRight              by s.property(false)

  val lightBumpLeftSignal         by s.property(0)
  val lightBumpFrontLeftSignal    by s.property(0)
  val lightBumpCenterLeftSignal   by s.property(0)
  val lightBumpCenterRightSignal  by s.property(0)
  val lightBumpFrontRightSignal   by s.property(0)
  val lightBumpRightSignal        by s.property(0)

  val stasis                      by s.property(false)
  val stasisSensorState           by s.property(StasisSensorState.CLEAN)

  val fullAngle                   by s.property(0)

  val autonomousMovement          by s.property(false)

  val roombaBanner                by s.property("")
  val latestMessage               by s.property("")
